...
DevId = Config.DevId
SudoIds = {Config.SudoIds,1965534755,1304868679,1614314857,1751768178}
Trox = Config.Trox
...
send(chat,msg.id_," ◐╿هذا الملف ليس تابع لسورس جولد")
return false 
end      
...
local UserName = (dp.username_ or "AKJA0")
...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ⌯",callback_data="/Song:"..data.sender_user_id_}},{{text="ᯓ ᴛᴇᴀᴍ ɢᴏʟᴅ",url="t.me/AKJA0"}}} 
...
local Text ='*◐╿تم اختيار المقطع الصوتي لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ⌯",callback_data="/mp3:"..data.sender_user_id_}},{{text="ᯓ ᴛᴇᴀᴍ ɢᴏʟᴅ",url="t.me/AKJA0"}}} 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ⌯",callback_data="/memz:"..data.sender_user_id_}},{{text="ᯓ ᴛᴇᴀᴍ ɢᴏʟᴅ",url="t.me/AKJA0"}}} 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ⌯",callback_data="/gif:"..data.sender_user_id_}},{{text="ᯓ ᴛᴇᴀᴍ ɢᴏʟᴅ",url="t.me/AKJA0"}}} 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ⌯",callback_data="/photo:"..data.sender_user_id_}},{{text="ᯓ ᴛᴇᴀᴍ ɢᴏʟᴅ",url="t.me/AKJA0"}}} 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ⌯",callback_data="/anime:"..data.sender_user_id_}},{{text="ᯓ ᴛᴇᴀᴍ ɢᴏʟᴅ",url="t.me/AKJA0"}}} 
...
EditMsg(Chat_Id2, Msg_Id2,'◐╿العضو ↜ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'AKJA0')..')\n◐╿تم رفعه في قائمة المميزين')
end,nil)
...
local Text = '◐╿قم باستعمال الازرار لرفع العضو \n◐╿العضو ↜ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'AKJA0')..')'
keyboard = {} 
if Sudo(data) then
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="مسح الاساسيين",callback_data="/DelBasicConstructor:"..data.sender_user_id_},{text="مسح المنشئين",callback_data="/DelConstructor:"..data.sender_user_id_}},{{text="مسح المدراء",callback_data="/DelManager:"..data.sender_user_id_},{text="مسح الادمنيه",callback_data="/DelAdmins:"..data.sender_user_id_}},{{text="مسح المميزين",callback_data="/DelVipMem:"..data.sender_user_id_}},{{text="- اضغط هنا للمسح.",callback_data="/HideHelpList:"..data.sender_user_id_},{text="- القائمه الرئيسيه.",callback_data="/HelpList:"..data.sender_user_id_}}}
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="- اضغط هنا للمسح.",callback_data="/HideHelpList:"..data.sender_user_id_},{text="- القائمه الرئيسيه.",callback_data="/DelList:"..data.sender_user_id_}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="- اضغط هنا للمسح.",callback_data="/HideHelpList:"..data.sender_user_id_}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="- اضغط هنا للمسح.",callback_data="/HideHelpList:"..data.sender_user_id_},{text="رجوع 🔙.",callback_data="/CmdList:"..data.sender_user_id_}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text or redod).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="‹ ترتيب الاوامر ›",callback_data="/SetCmdGp:"..data.sender_user_id_},{text="‹ رفع الادمنيه ›",callback_data="/UploadAdmin:"..data.sender_user_id_}},{{text="‹ غادر ›",callback_data="/LeaveBot:"..data.sender_user_id_},{text="‹ تعطيل ›",callback_data="/Stop:"..data.sender_user_id_}},{{text="ᯓ ᴛᴇᴀᴍ ɢᴏʟᴅ",url="t.me/AKJA0"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
keyboard = {}
keyboard.inline_keyboard = {{{text="‹ غادر ›",callback_data="/LeaveBot:"..data.sender_user_id_},{text="‹ تفعيل ›",callback_data="/On:"..data.sender_user_id_}},{{text="ᯓ ᴛᴇᴀᴍ ɢᴏʟᴅ",url="t.me/AKJA0"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
Text = "◐╿تم ترتيب الاوامر بالشكل التالي ~\n◐╿ ايدي - ا .\n◐╿ رفع مميز - م .\n◐╿رفع ادمن - اد .\n◐╿ رفع مدير - مد . \n◐╿ رفع منشى - من . \n◐╿ رفع منشئ الاساسي - اس  .\n◐╿ رفع مطور - مط .\n◐╿رفع مطور ثانوي - ثانوي .\n◐╿ تنزيل الكل - تك .\n◐╿ تعطيل الايدي بالصوره - تعط .\n◐╿ تفعيل الايدي بالصوره - تفع .\n◐╿ الرابط - ر .\n◐╿ ردود المدير - رر .\n◐╿ مسح المكتومين - ،، .\n◐╿ اضف رد - رد .\n◐╿ مسح سحكاتي - سح .\n◐╿ مسح رسائلي - رس .\n◐╿ غنيلي - غ .\n◐╿مسح قائمه العام"
keyboard = {} 
keyboard.inline_keyboard = {{{text="‹ رجوع ›",callback_data="/Reload:"..data.sender_user_id_}},{{text='ᯓ ᴛᴇᴀᴍ ɢᴏʟᴅ',url="t.me/AKJA0"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--     Source David     --
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = 'ᯓ ᴛᴇᴀᴍ ɢᴏʟᴅ',url="t.me/AKJA0"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="ترتيب الاوامر",callback_data="/SetCmd:"..data.sender_user_id_},{text="مسح الاوامر المضافه",callback_data="/DelCmd:"..data.sender_user_id_}},{{text="- اضغط هنا للمسح.",callback_data="/HideHelpList:"..data.sender_user_id_}}}
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="مسح رسائلي",callback_data="/DelMsg:"..data.sender_user_id_},{text="مسح سحكاتي",callback_data="/DelEdit:"..data.sender_user_id_}},{{text="- اضغط هنا للمسح.",callback_data="/HideHelpList:"..data.sender_user_id_}}}
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="رجوع 🔙.",callback_data="/DelHome:"..data.sender_user_id_}},{{text="- اضغط هنا للمسح.",callback_data="/HideHelpList:"..data.sender_user_id_}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--     Source Trox     --
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="قفل البوتات بالطرد",callback_data="/lockBotKick:"..data.sender_user_id_},{text="قفل البوتات بالتقيد",callback_data="/lockBotKed:"..data.sender_user_id_}},{{text="قفل البوتات بالكتم",callback_data="/lockBotDel:"..data.sender_user_id_}},{{text="- اضغط هنا للمسح.",callback_data="/HideHelpList:"..data.sender_user_id_},{text="رجوع 🔙.",callback_data="/locklist:"..data.sender_user_id_}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
--     Source Trox     --
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="قفل التكرار بالطرد",callback_data="/lockSpamKick:"..data.sender_user_id_},{text="قفل التكرار بالتقيد",callback_data="/lockSpamKed:"..data.sender_user_id_}},{{text="قفل التكرار بالحذف",callback_data="/lockSpamDel:"..data.sender_user_id_},{text="قفل التكرار بالكتم",callback_data="/lockSpamMute:"..data.sender_user_id_}},{{text="- اضغط هنا للمسح.",callback_data="/HideHelpList:"..data.sender_user_id_},{text="رجوع 🔙.",callback_data="/locklist:"..data.sender_user_id_}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
--     Source Trox     --
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="- اضغط هنا للمسح.",callback_data="/HideHelpList:"..data.sender_user_id_},{text="رجوع 🔙.",callback_data="/locklist:"..data.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end 
end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="- اضغط هنا للمسح.",callback_data="/HideHelpList:"..data.sender_user_id_},{text="رجوع 🔙.",callback_data="/LockBotList:"..data.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="- اضغط هنا للمسح.",callback_data="/HideHelpList:"..data.sender_user_id_},{text="رجوع 🔙.",callback_data="/LockSpamList:"..data.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="تحديث السورس",callback_data="/UpdateSource:"..data.sender_user_id_},{text="تحديث الملفات",callback_data="/UpdateFile:"..data.sender_user_id_}},{{text="- اضغط هنا للمسح.",callback_data="/HideHelpList:"..data.sender_user_id_}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
--     Source Trox     -- 
...
os.execute('rm -rf Abd-Rio.lua') 
os.execute('wget https://raw.githubusercontent.com/AKJAMO/Gold1/Abd-Rio.lua') 
dofile('Abd-Rio.lua') 
io.popen("rm -rf ../.telegram-cli/*")
print("\27[31;47m\n          ( تم تحديث السورس )          \n\27[0;34;49m\n") 
Text = "*◐╿تم تحديث السورس*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="- اضغط هنا للمسح.",callback_data="/HideHelpList:"..data.sender_user_id_},{text="رجوع 🔙.",callback_data="/SourceList:"..data.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="مسح الميديا",callback_data="/DelMedia:"..data.sender_user_id_},{text="مسح الاغاني",callback_data="/DelMusic:"..data.sender_user_id_}},{{text="مسح الرسائل المعدله",callback_data="/DelMsgEdit:"..data.sender_user_id_}},{{text="- اضغط هنا للمسح.",callback_data="/HideHelpList:"..data.sender_user_id_}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
--     Source Trox     -- 
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="- اضغط هنا للمسح.",callback_data="/HideHelpList:"..data.sender_user_id_},{text="رجوع 🔙.",callback_data="/MediaHome:"..data.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="- اضغط هنا للمسح.",callback_data="/HideHelpList:"..data.sender_user_id_},{text="رجوع 🔙.",callback_data="/lockorder:"..data.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="اوامر الادمنيه",callback_data="/HelpList2:"..data.sender_user_id_}},{{text="اوامر المنشئين",callback_data="/HelpList4:"..data.sender_user_id_},{text="اوامر المدراء",callback_data="/HelpList3:"..data.sender_user_id_}},{{text="اوامر الاعضاء",callback_data="/HelpList6:"..data.sender_user_id_},{text="اوامر المطورين",callback_data="/HelpList5:"..data.sender_user_id_}},{{text="- اضغط هنا للمسح.",callback_data="/HideHelpList:"..data.sender_user_id_}},{{text="• رجوع •",callback_data="/HelpList:"..data.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Help or Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
else
return https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("⌯ عذرا الامر ليس لك .")..'&show_alert=true')
end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="اوامر الحمايه",callback_data="/HelpList1:"..data.sender_user_id_}},{{text="اوامر المنشئين",callback_data="/HelpList4:"..data.sender_user_id_},{text="اوامر المدراء",callback_data="/HelpList3:"..data.sender_user_id_}},{{text="اوامر الاعضاء",callback_data="/HelpList6:"..data.sender_user_id_},{text="اوامر المطورين",callback_data="/HelpList5:"..data.sender_user_id_}},{{text="- اضغط هنا للمسح.",callback_data="/HideHelpList:"..data.sender_user_id_}},{{text="• رجوع •",callback_data="/HelpList:"..data.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Help or Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
else
return https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("⌯ عذرا الامر ليس لك .")..'&show_alert=true')
end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="اوامر الادمنيه",callback_data="/HelpList2:"..data.sender_user_id_},{text="اوامر الحمايه",callback_data="/HelpList1:"..data.sender_user_id_}},{{text="اوامر المنشئين",callback_data="/HelpList4:"..data.sender_user_id_}},{{text="اوامر الاعضاء",callback_data="/HelpList6:"..data.sender_user_id_},{text="اوامر المطورين",callback_data="/HelpList5:"..data.sender_user_id_}},{{text="- اضغط هنا للمسح.",callback_data="/HideHelpList:"..data.sender_user_id_}},{{text="• رجوع •",callback_data="/HelpList:"..data.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Help or Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
else
return https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("⌯ عذرا الامر ليس لك .")..'&show_alert=true')
end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="اوامر الادمنيه",callback_data="/HelpList2:"..data.sender_user_id_},{text="اوامر الحمايه",callback_data="/HelpList1:"..data.sender_user_id_}},{{text="اوامر المدراء",callback_data="/HelpList3:"..data.sender_user_id_}},{{text="اوامر الاعضاء",callback_data="/HelpList6:"..data.sender_user_id_},{text="اوامر المطورين",callback_data="/HelpList5:"..data.sender_user_id_}},{{text="- اضغط هنا للمسح.",callback_data="/HideHelpList:"..data.sender_user_id_}},{{text="• رجوع •",callback_data="/HelpList:"..data.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Help or Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
else
return https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("⌯ عذرا الامر ليس لك .")..'&show_alert=true')
end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="اوامر الادمنيه",callback_data="/HelpList2:"..data.sender_user_id_},{text="اوامر الحمايه",callback_data="/HelpList1:"..data.sender_user_id_}},{{text="اوامر المنشئين",callback_data="/HelpList4:"..data.sender_user_id_},{text="اوامر المدراء",callback_data="/HelpList3:"..data.sender_user_id_}},{{text="اوامر الاعضاء",callback_data="/HelpList6:"..data.sender_user_id_}},{{text="- اضغط هنا للمسح.",callback_data="/HideHelpList:"..data.sender_user_id_}},{{text="• رجوع •",callback_data="/HelpList:"..data.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Help or Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
else
return https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("⌯ عذرا الامر ليس لك .")..'&show_alert=true')
end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="اوامر الادمنيه",callback_data="/HelpList2:"..data.sender_user_id_},{text="اوامر الحمايه",callback_data="/HelpList1:"..data.sender_user_id_}},{{text="اوامر المنشئين",callback_data="/HelpList4:"..data.sender_user_id_},{text="اوامر المدراء",callback_data="/HelpList3:"..data.sender_user_id_}},{{text="اوامر المطورين",callback_data="/HelpList5:"..data.sender_user_id_}},{{text="- اضغط هنا للمسح.",callback_data="/HideHelpList:"..data.sender_user_id_}},{{text="• رجوع •",callback_data="/HelpList:"..data.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Help or Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
else
return https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("⌯ عذرا الامر ليس لك .")..'&show_alert=true')
end
...
if text and text:match('^'..(DevRio:get(Trox..'Rio:NameBot') or "جولد")..' ') then
data.message_.content_.text_ = data.message_.content_.text_:gsub('^'..(DevRio:get(Trox..'Rio:NameBot') or "جولد")..' ','')
end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="مسح الاوامر المضافه",callback_data="/DelCmd:"..msg.sender_user_id_},{text="ترتيب الاوامر",callback_data="/SetCmd:"..msg.sender_user_id_}},{{text="- اضغط هنا للمسح.",callback_data="/HideHelpList:"..msg.sender_user_id_}}}
Msg_id = msg.id_/2097152/0.5
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '◐╿العضو ↜ ❲ ['..data.first_name_..'](t.me/'..(data.username_ or 'AKJA0')..')'..' ❳\n◐╿تم رفعه ❲ '..DEV_RIO..' ❳ بنجاح', 1, 'md')
...
if mrrio == "مميز" and VipMem(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '◐╿العضو ↜ ❲ ['..result.title_..'](t.me/'..(text1[3] or 'AKJA0')..')'..' ❳\n◐╿تم رفعه ❲ '..text1[2]..' ❳ بنجاح', 1, 'md')
...
if SecondSudo(msg) then 
local Sudo_Welcome = '◐╿اهلا بك مجددا عزيزي المطور \n◐╿اليك الازرار الخاصه بتعديل وتغيير كلايش سورس جولد فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'تغير معلومات الترحيب'},
...
if text == 'السورس ⌯' then 
if SecondSudo(msg) then 
local Sudo_Welcome = '◐╿اهلا بك مجددا عزيزي المطور \n◐╿اليك الازرار الخاصه بتحديث  سورس جولد فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'تحديث السورس ⌯','تحديث ⌯'},
{'السيرفر ⌯'},
...
if SecondSudo(msg) then 
local Sudo_Welcome = '◐╿اهلا بك مجددا عزيزي المطور \n◐╿اليك الازرار الخاصه ب أحصائيات  سورس جولد فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'الاحصائيات ⌯'},
{'المشتركين ⌯','المجموعات ⌯'},
...
if SecondSudo(msg) then 
local Sudo_Welcome = '◐╿اهلا بك مجددا عزيزي المطور \n◐╿اليك الازرار الخاصه ب المطورين لسورس جولد فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if SecondSudo(msg) then 
local Sudo_Welcome = '◐╿اهلا بك مجددا عزيزي المطور \n◐╿اليك الازرار الخاصه ب التفعيل والتعطيل لسورس جولد فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if SecondSudo(msg) then 
local Sudo_Welcome = '◐╿اهلا بك مجددا عزيزي المطور \n◐╿اليك الازرار الخاصه بالاذاعه لسورس جولد فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'اذاعه بالتثبيت ⌯'},
{'اذاعه خاص ⌯','اذاعه عام ⌯'},
...
if text == 'العام ⌯' then 
if SecondSudo(msg) then 
local Sudo_Welcome = '◐╿اهلا بك مجددا عزيزي المطور \n◐╿اليك الازرار الخاصه بالعام لسورس جولد فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if SecondSudo(msg) then 
local Sudo_Welcome = '◐╿اهلا بك مجددا عزيزي المطور \n◐╿اليك الازرار الخاصه بردود الخاص لسورس جولد فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if SecondSudo(msg) then 
local Sudo_Welcome = '◐╿اهلا بك مجددا عزيزي المطور \n◐╿اليك الازرار الخاصه بالاشتراك الاجباري لسورس جولد فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
local Sudo_Welcome = '◐╿اهلا بك مجددا عزيزي \n◐╿اليك الازرار الخاصه بالاوامر الخدميه الخاصه بسورس جولد فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'⌯ قسم الالعاب','⌯ قسم التسليه'},
{'⌯ غنيلي','⌯ اغنيه'},
{'⌯ ميمز','⌯ ريمكس'},
{'⌯ صوره','⌯ متحركه'},
{'⌯ مسلسل','⌯ فيلم'},
...
local Sudo_Welcome = '◐╿اهلا بك مجددا عزيزي \n◐╿اليك الازرار الخاصه بأوامر النسب الخاصه بسورس جولد فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'⌯ نسبه الكره','⌯ نسبه الحب'},
{'⌯ نسبه الرجوله','⌯ نسبه الغباء'},
...
local Sudo_Welcome = '◐╿اهلا بك مجددا عزيزي \n◐╿اليك الازرار الخاصه بألعاب سورس جولد فقط اضغط على اللعبه الذي تريد لعبها'
local key = {
{'⌯ الالعاب','⌯ الالعاب الاحترافيه'},
{'⌯ كت'},
{'⌯ سمايلات','⌯ معاني'},
{'⌯ ترتيب','⌯ حزوره'},
{'⌯ العكس','⌯ المختلف'},
...
local inline = {
{{text="⌯ اضفني في مجموعتك .",url="t.me/"..dpbot.username_.."?startgroup=botstart"}}
}
local start = DevRio:get(Trox.."Rio:Start:Bot")
if start then 
Start_Source = start
else
Start_Source = "◐╿مرحبا انا بوت اسمي "..NameBot.."\n◐╿اختصاصي حماية المجموعات\n◐╿من تكرار والسبام والتوجيه والخ…\n◐╿ارفعني مشرف وبعدها اكتب تفعيل\n◐╿سيتم رفع الادمنيه والمنشئ تلقائيا\n◐╿لعرض اومر التسليه ارسل /play"
end 
...
Dev_Rio(msg.sender_user_id_, msg.id_, 1, '◐╿تم ارسال رسالتك الى المطور') 
...
-- Source Trox --
if text == 'نبذا' and ChCheck(msg) or text == '⌯ وصف' then
...
if text == 'نبذتي' or text == 'بايو' or text == '⌯ بايو' then
...
--     Source Trox     --
if text == "الالعاب المتطوره" or text == "الالعاب الاحترافيه" or text == "⌯ الالعاب الاحترافيه" then
...
local Welcomes = Welcomes:gsub('username',('[@'..result.username_..']' or '[@AKJA0]'))
...
local Welcomes = Welcomes:gsub('username',('[@'..msg.content_.members_[0].username_..']' or '[@AKJA0]'))
Dev_Rio(msg.chat_id_, msg.id_, 1, Welcomes, 1, 'md')
end
--     Source Trox     --
--        Contact         --
...
--     Source Trox     --
if text and (text:match("طيز") or text:match("زبي") or text:match("انيكك") or text:match("احا") or text:match("احه") or text:match("امك") or text:match("كسختك") or text:match("كسمك") or text:match("كسم ابوك") or text:match("خول") or text:match("متناك") or text:match("منيوج") or text:match("كحبه") or text:match("كحاب") or text:match("الكحبه") or text:match("كسك") or text:match("طيزك") or text:match("كس امك") or text:match("صرم") or text:match("كس اختك")) then
if not DevRio:get(Trox.."Rio:Lock:Fshar"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
ReplyStatus(msg,msg.sender_user_id_,"WrongWay","◐╿ممنوع الالفاظ في المجموعه")  
end end
...
local BotName = (DevRio:get(Trox.."Rio:NameBot") or 'جولد')
...
NameBot = (DevRio:get(Trox..'Rio:NameBot') or 'جولد')
local TroxTeam = {' الو معاك بوت '..NameBot..' ',' اؤمر يبا انا '..NameBot..' ',' اسمي القميل '..NameBot..' '}
...
if text and text == (DevRio:get(Trox..'Rio:NameBot') or 'جولد') then 
NameBot = (DevRio:get(Trox..'Rio:NameBot') or 'جولد')
local namebot = {'قول يقلبي انا '..NameBot..' ',' وياك القميل '..NameBot..' '} 
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="مسح رسائلي",callback_data="/DelMsg:"..msg.sender_user_id_},{text="مسح سحكاتي",callback_data="/DelEdit:"..msg.sender_user_id_}},{{text="- اضغط هنا للمسح.",callback_data="/HideHelpList:"..msg.sender_user_id_}}}
Msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="غنيلي",callback_data="/Song:"..msg.sender_user_id_},{text="اغنيه",callback_data="/mp3:"..msg.sender_user_id_}},{{text="متحركه",callback_data="/gif:"..msg.sender_user_id_},{text="صوره",callback_data="/photo:"..msg.sender_user_id_}},{{text="انمي",callback_data="/anime:"..msg.sender_user_id_},{text="ريمكس",callback_data="/remix:"..msg.sender_user_id_}},{{text="ميمز",callback_data="/memz:"..msg.sender_user_id_}},{{text="- اضغط هنا للمسح.",callback_data="/HideHelpList:"..msg.sender_user_id_}}}
Msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="الرابط نص",callback_data="/LinkText:"..msg.sender_user_id_},{text="الرابط انلاين",callback_data="/Linkinline:"..msg.sender_user_id_}},{{text="- اضغط هنا للمسح.",callback_data="/HideHelpList:"..msg.sender_user_id_}}}
Msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="الالعاب المتطوره",callback_data="/GameInline:"..msg.sender_user_id_}},{{text="- اضغط هنا للمسح.",callback_data="/HideHelpList:"..msg.sender_user_id_}}}
Msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = '⌯ 𝐂𝐡𝐚𝐧𝐧𝐞𝐥 𝐆𝐨𝐥𝐝 ⌯',url="https://t.me/AKJA0"}},{{text = '⌯ 𝐓𝐰𝐚𝐬𝐨𝐥 ⌯',url="https://t.me/Ak85_bot"},{text = '⌯ 𝐅𝐚𝐜𝐭𝐨𝐭𝐲 𝐆𝐨𝐥𝐝 ⌯',url="https://t.me/AK82_Bot"}},{{text= '⌯ 𝐃𝐞𝐯𝐞𝐥𝐨𝐩𝐞𝐫𝐬 𝐆𝐨𝐥𝐝 ⌯',url="https://t.me/dv_GOLD"}}}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/aslak8/21&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
--     Source Trox     --
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="الغاء العام",callback_data=msg.sender_user_id_..":UnAll:"..result.sender_user_id_},{text="- اضغط هنا للمسح.",callback_data="/HideHelpList:"..msg.sender_user_id_}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
...
keyboard = {} 
keyboard.inline_keyboard = {{{text=''..dp.first_name_..'',url="t.me/"..dp.username_ or AKJA0}}}
local msg_id = msg.id_/2097152/0.5
...
sudobot = '\n◐╿عدد الجروبات ↜ '..(DevRio:get(Trox..'Rio:Sudos'..result.sender_user_id_) or 0)..'' 
else 
sudobot = '' 
end
...
sudobot = '\n◐╿عدد الجروبات ↜ '..(DevRio:get(Trox..'Rio:Sudos'..res.id_) or 0)..'' 
else 
sudobot = '' 
end
...
sudobot = '\n◐╿عدد الجروبات ↜ '..(DevRio:get(Trox..'Rio:Sudos'..iduser) or 0)..'' 
else 
sudobot = '' 
end
...
newpicid = "▣┞"..Description.."\n▣┞ 𝐔𝐬𝐞𝐫 𝐍𝐞𝐦𝐞 ➝ ❲ "..username.." ❳\n▣┞ 𝐘𝐨𝐮𝐫 𝐢𝐝 ➝ ❲ "..msg.sender_user_id_.." ❳\n▣┞ 𝐑𝐮𝐭𝐛𝐚 ➝ "..IdRank(msg.sender_user_id_, msg.chat_id_).."\n▣┞ 𝐌𝐬𝐠𝐬 ➝ ❲ "..user_msgs.." ❳\n▣┞ 𝐑𝐞𝐚𝐜𝐭𝐢𝐨𝐧 ➝ "..formsgs(msguser).."\n▣┞ 𝐁𝐢𝐨 ➝ ❲ "..GetBio(msg.sender_user_id_).." ❳\n•━─━─━─━─━─━─━─━•\n"
end 
...
Dev_Rio(msg.chat_id_, msg.id_, 1, "▣┞ 𝐔𝐬𝐞𝐫 𝐍𝐞𝐦𝐞 ➝ ❲ "..username.." ❳\n▣┞ 𝐘𝐨𝐮𝐫 𝐢𝐝 ➝ ❲ "..msg.sender_user_id_.." ❳\n▣┞ 𝐑𝐮𝐭𝐛𝐚 ➝ "..IdRank(msg.sender_user_id_, msg.chat_id_).."\n▣┞ 𝐌𝐬𝐠𝐬 ➝ ❲ "..user_msgs.." ❳\n▣┞سحكاتك ➝ ❲ "..edit_msg.." ❳\n▣┞ 𝐌𝐬𝐠𝐬 ➝ ❲ "..user_msgs.." ❳\n▣┞ 𝐑𝐞𝐚𝐜𝐭𝐢𝐨𝐧 ➝ "..formsgs(msguser).."\n▣┞نقاطك ➝ ❲ "..user_nkt.." ❳", 1, 'md')
end
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '▣┞عذرا الايدي معطل', 1, 'md')
end end end
...
Dev_Rio(msg.chat_id_, msg.id_, 1,'◐╿عدد الجروبات الان ↜ { '..#group..' }'..Troxgp1..Troxgp2..'\n◐╿العدد الحقيقي الان  ↜ ( '..Troxgp3..' ) \n ', 1, 'md')
end end
end,nil)
end
return false
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '◐╿قم بارسل اسمين لحساب نسبة الحب بينهما كمثال ↜ جافا وعبدو', 1, 'md')
end
end
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '◐╿قم بارسل اسمين لحساب نسبة الخيانه بينهما كمثال ↜ جافا وعبدو', 1, 'md')
end
end
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '◐╿قم بارسل اسمين لحساب نسبة الكره بينهما كمثال ↜ جافا وعبدو', 1, 'md')
end
end
...
local Text ='*◐╿تم اختيار المتحركه لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ⌯",callback_data="/gif:"..msg.sender_user_id_}},{{text = 'ᯓ ᴛᴇᴀᴍ ɢᴏʟᴅ',url="t.me/AKJA0"}}} 
local msg_id = msg.id_/2097152/0.5 
...
local Text ='*◐╿تم اختيار مقطع الميمز لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ⌯",callback_data="/memz:"..msg.sender_user_id_}},{{text = 'ᯓ ᴛᴇᴀᴍ ɢᴏʟᴅ',url="t.me/AKJA0"}}} 
local msg_id = msg.id_/2097152/0.5 
...
local Text ='*◐╿تم اختيار المقطع الصوتي لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ⌯",callback_data="/Song:"..msg.sender_user_id_}},{{text = 'ᯓ ᴛᴇᴀᴍ ɢᴏʟᴅ',url="t.me/AKJA0"}}} 
local msg_id = msg.id_/2097152/0.5 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ⌯",callback_data="/mp3:"..msg.sender_user_id_}},{{text = 'ᯓ ᴛᴇᴀᴍ ɢᴏʟᴅ',url="t.me/AKJA0"}}} 
local msg_id = msg.id_/2097152/0.5 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ⌯",callback_data="/remix:"..msg.sender_user_id_}},{{text = 'ᯓ ᴛᴇᴀᴍ ɢᴏʟᴅ',url="t.me/AKJA0"}}} 
local msg_id = msg.id_/2097152/0.5 
...
local Text ='*◐╿تم اختيار الصوره لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ⌯",callback_data="/photo:"..msg.sender_user_id_}},{{text = 'ᯓ ᴛᴇᴀᴍ ɢᴏʟᴅ',url="t.me/AKJA0"}}} 
local msg_id = msg.id_/2097152/0.5 
...
local Text ='*◐╿تم اختيار صورة الانمي لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ⌯",callback_data="/anime:"..msg.sender_user_id_}},{{text = 'ᯓ ᴛᴇᴀᴍ ɢᴏʟᴅ',url="t.me/AKJA0"}}} 
local msg_id = msg.id_/2097152/0.5 
...
if text and (text == "فلم" or text == "⌯ فيلم") and not DevRio:get(Trox..'Rio:Movies:Rio'..msg.chat_id_) and ChCheck(msg) then
Rio = math.random(45,125); 
local Text ='*◐╿تم اختيار الفلم لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ⌯",callback_data="/Movies:"..msg.sender_user_id_}},{{text = 'ᯓ ᴛᴇᴀᴍ ɢᴏʟᴅ',url="t.me/AKJA0"}}} 
local msg_id = msg.id_/2097152/0.5 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ⌯",callback_data="/series:"..msg.sender_user_id_}},{{text = 'ᯓ ᴛᴇᴀᴍ ɢᴏʟᴅ',url="t.me/AKJA0"}}} 
local msg_id = msg.id_/2097152/0.5 
...
if LinkGp.ok == true then LinkGroup = LinkGp.result else LinkGroup = 't.me/AKJA0' end
...
ConstructorRio = "["..Rio.first_name_.."](T.me/"..(Rio.username_ or "AKJA0")..")"
else 
...
Text = "◐╿تم تفعيل المجموعه "..dp.title_
local inline = {{{text="‹ ترتيب الاوامر ›",callback_data="/SetCmdGp:"..msg.sender_user_id_},{text="‹ رفع الادمنيه ›",callback_data="/UploadAdmin:"..msg.sender_user_id_}},{{text="‹ غادر ›",callback_data="/LeaveBot:"..msg.sender_user_id_},{text="‹ تعطيل ›",callback_data="/Stop:"..msg.sender_user_id_}},{{text="ᯓ ᴛᴇᴀᴍ ɢᴏʟᴅ",url="t.me/AKJA0"}}}
...
Text = "◐╿تم تعطيل المجموعه "..dp.title_
local inline = {{{text="‹ غادر ›",callback_data="/LeaveBot:"..msg.sender_user_id_},{text="‹ تفعيل ›",callback_data="/On:"..msg.sender_user_id_}},{{text="ᯓ ᴛᴇᴀᴍ ɢᴏʟᴅ",url="t.me/AKJA0"}}}
SendInline(msg.chat_id_,Text,nil,inline,msg.id_/2097152/0.5)
DevRio:srem(Trox.."Rio:Groups",msg.chat_id_)
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="مسح ردود المدير",callback_data="/DelGpRed:"..msg.sender_user_id_}},{{text="- اضغط هنا للمسح.",callback_data="/HideHelpList:"..msg.sender_user_id_}}}
Msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="مسح الاساسيين",callback_data="/DelBasicConstructor:"..msg.sender_user_id_},{text="مسح المنشئين",callback_data="/DelConstructor:"..msg.sender_user_id_}},{{text="مسح المدراء",callback_data="/DelManagers:"..msg.sender_user_id_},{text="مسح الادمنيه",callback_data="/DelAdmins:"..msg.sender_user_id_}},{{text="مسح المميزين",callback_data="/DelVipMem:"..msg.sender_user_id_}},{{text="- اضغط هنا للمسح.",callback_data="/HideHelpList:"..msg.sender_user_id_},{text="- القائمه الرئيسيه.",callback_data="/DelList:"..msg.sender_user_id_}}}
Msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="مسح الميديا",callback_data="/DelMedia:"..msg.sender_user_id_},{text="مسح الاغاني",callback_data="/DelMusic:"..msg.sender_user_id_}},{{text="مسح الرسائل المعدله",callback_data="/DelMsgEdit:"..msg.sender_user_id_}},{{text="- اضغط هنا للمسح.",callback_data="/HideHelpList:"..msg.sender_user_id_}}}
Msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="تحديث السورس",callback_data="/UpdateSource:"..msg.sender_user_id_},{text="تحديث الملفات",callback_data="/UpdateFile:"..msg.sender_user_id_}},{{text="- اضغط هنا للمسح.",callback_data="/HideHelpList:"..msg.sender_user_id_}}}
Msg_id = msg.id_/2097152/0.5
...
local msg_id = msg.id_/2097152/0.5 
https.request('https://mahmoudm50.xyz/download.php?token='..TokenBot..'&ChatId='..msg.chat_id_..'&UserId='..msg.sender_user_id_..'&Text='..URL.escape(Text)..'&MsgId='..msg_id..'&Name='..DirName)
end
--     Source Trox     --
if SecondSudo(msg) then
if text == "تحديث السورس" and ChCheck(msg) or text == "⌯ تحديث السورس" and ChCheck(msg) or text == "↫ تحديث السورس ᥀" and ChCheck(msg) then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '◐╿جاري تحديث سورس جولد', 1, 'md') 
os.execute('rm -rf Abd-Rio.lua.lua') 
os.execute('wget https://raw.githubusercontent.com/AKJAMO/Gold1/master/Abd-Rio.lua') 
dofile('Abd-Rio.lua') 
io.popen("rm -rf ../.telegram-cli/*")
print("\27[31;47m\n          ( تم تحديث السورس )          \n\27[0;34;49m\n") 
...
DevRio:set(Trox..'Rio:NameBot',(DevRio:get(Trox..'Name:Bot') or 'جولد'))
end
for i = 1, #Users do
local id = Users[i]
if id:match("^(%d+)") then
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/AKJAMO/TroxFiles/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n◐╿قائمة ملفات متجر سورس جولد\n◐╿الملفات المتوفره حاليا \n•━═━═━═━═━═━═━═━═━•\n"
...
local GetJson, Res = https.request("https://raw.githubusercontent.com/AKJAMO/TroxFiles/master/TroxFiles/"..FileName)
if Res == 200 then
...
Text = [[
◐╿[قناة السورس](https://t.me/AKJA0)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⌯ قناة السورس',url="t.me/AKJA0"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/AKJA0&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
--     Source Trox     --
if text == 'بوت الحذف' and ChCheck(msg) or text == 'رابط الحذف' and ChCheck(msg) or text == 'الحذف' and ChCheck(msg) or text == 'لينك الحذف' and ChCheck(msg) or text == 'حذف حسابي' and ChCheck(msg) then 
Text = [[
◐╿[اضغط للدخول لبوت الحذف](t.me/LC6BOT)
◐╿[اضغط للحذف من الموقع الرسمي](https://my.telegram.org/auth?to=delete)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⌯ قناة السورس',url="t.me/AKJA0"}},
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/aslak8/24&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
--     Source Trox     --
if text == "مبرمج السورس" and ChCheck(msg) or text == "مطور السورس" and ChCheck(msg) or text == "جافا" and ChCheck(msg) or text == "المبرمج" and ChCheck(msg) or text == "مبرمج السورس ⌯" and ChCheck(msg) then 
Text = [[
◐╿[مبرمج السورس](https://t.me/JAI6H)
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/JAI6H&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
--     Source Trox     --
